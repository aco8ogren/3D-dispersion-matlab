function [global_stiffness_matrix,global_mass_matrix] = get_system_matrices_GPU(const)
    ...
    elementwise_design = repelem(gpuArray(const.design),const.N_ele(1),const.N_ele(2),const.N_ele(3),1);
    ...
    global_node_numbers_grid = reshape(gpuArray(1:number_of_nodes),N_node_global);
